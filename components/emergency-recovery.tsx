...
export function EmergencyRecovery() {
  ...
  return (
    <Card className="border-red-500/20 bg-gradient-to-b from-red-500/5 via-zinc-950/60 to-zinc-950 p-5 shadow-lg transition-all">
      {/* Collapsible Header */}
      <button
        type="button"
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <Badge variant="outline" className="border-red-500/30 bg-red-500/10 text-red-300 font-mono text-[10px]">
                cancelStaleRound
              </Badge>
              {isEmergencyStale && (
        ...
        <div className="flex items-center gap-3">
          <Badge
            variant="outline"
            className={`text-xs font-semibold px-2.5 py-1 border hidden sm:inline-flex ${
              isEmergencyStale
